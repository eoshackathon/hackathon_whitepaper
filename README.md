...
#### 发放方式：
除了***备用、空投***部分，28%的积分（计2.8亿枚）将分为150份，在每场赛事结束后发放。

为了奖励先期贡献者，发放数量按指数形式递减。

第一场赛事发放850万枚，以后每场赛事发放数量减少3%，直到第150场全部发完2.8亿枚。

前50场，将发放2.8亿枚中的80%，占总量的24%左右。
...
### <span id="12">十二、主办方</span>
#### 主办方：

* BTC Media：美国最大的区块链媒体集团 
